...
urlpatterns = [
    ...
    path('outcomes/<slug:slug>/', views.OutcomeMediaUpdateView.as_view(), name='outcome-media-update'),
    path('outcomes/<slug:slug>/edit/', views.OutcomeUpdateView.as_view(), name='outcome-update'),
