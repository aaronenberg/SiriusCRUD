    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outcome_type', models.CharField(blank=True, choices=[('', '---------'), ('RD', 'Raw Data'), ('AD', 'Analyzed Data'), ('CU', 'Curriculum'), ('OT', 'Other')], default='', help_text='Select the file type', max_length=2, verbose_name='outcome type')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
