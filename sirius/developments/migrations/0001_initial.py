    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('development_type', models.CharField(blank=True, choices=[('', '---------'), ('AD', 'Analyzed Data'), ('PO', 'Poster'), ('RD', 'Raw Data'), ('RE', 'Report'), ('OT', 'Other')], default='', help_text='Select the file type', max_length=2, verbose_name='development type')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('modified', models.DateTimeField(auto_now=True)),
